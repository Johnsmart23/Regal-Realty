...
const Detail = () => {
  // Contact numbers
  const callPhone = "08127790800";               // Local format for calling
  const whatsappPhone = "2348127790800";         // International format for WhatsApp

  // Images
  const mainImage = { src: '/images/Rectangle 67(1).png', alt: 'Main Photo (Photo 1)' };
  ...
  const galleryImages = [
    ...
    { src: '/images/Rectangle 95.png', label: 'Photo 7' },
  ];
  ...
  return (
    <div className="detail-container">
      ...
      <div className="detail-info">
        ...
        <h3 className="detail-price">#40,500,000</h3>
