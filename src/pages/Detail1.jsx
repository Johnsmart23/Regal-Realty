...
const Detail = () => {
  ...
  const rawPhone = "08127790800"; // For tel:
  const intlPhone = "2348127790800"; // For WhatsApp (no leading zero)

  // Images
  const mainImage = {
    src: '/images/1 details.png',
    alt: 'Main Photo (Photo 1)',
  };

  const galleryImages = [
    { src: '/images/5 details.png', label: 'Photo 1' },
    { src: '/images/detail 2.png', label: 'Photo 2' },
    { src: '/images/detail 3.png', label: 'Photo 3' },
    { src: '/images/detail 4.png', label: 'Photo 4' },
    { src: '/images/detail 5.png', label: 'Photo 5' },
  ...
  return (
    <div className="detail-container">
      ...
      <div className="detail-info">
        ...
        <h3 className="detail-price">₦18,500,000</h3>
        ...
        <div className="contact-buttons-vertical">
          <a href={`tel:${rawPhone}`} className="call-button">
            Call Agent
          </a>
          <a
            href={`https://wa.me/${intlPhone}?text=Hello,%20I'm%20interested%20in%20your%20property%20listing.`}
