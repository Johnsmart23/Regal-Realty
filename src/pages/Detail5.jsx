...
const Detail = () => {
  ...
  const callPhone = "08127790800";               // Nigerian format
  const whatsappPhone = "2348127790800";         // International format for WhatsApp

  // Images
  const mainImage = { src: 'images/Rectangle 95(1).png', alt: 'Main Photo (Photo 1)' };
  ...
  return (
    <div className="detail-container">
      ...
      <div className="detail-info">
        ...
        <h3 className="detail-price">#10,000,000</h3>
