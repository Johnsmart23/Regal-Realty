...
const Detail = () => {
  ...
  // Images
  const mainImage = { src: '/images/Rectangle 67.png', alt: 'Main Photo (Photo 1)' };

  const galleryImages = [
    { src: '/images/Image 11.png', label: 'Photo 1' },
    { src: '/images/Image 12.png', label: 'Photo 2' },
    { src: '/images/Image 14.png', label: 'Photo 3' },
    { src: '/images/detail 1.png', label: 'Photo 4' },
  ...
  return (
    <div className="detail-container">
      ...
      <div className="detail-info">
        ...
        <h3 className="detail-price">#8,500,000</h3>
