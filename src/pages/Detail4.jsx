...
const Detail = () => {
  // Agent's contact
  const callPhone = "08127790800"; // local format
  const whatsappPhone = "2348127790800"; // international format

  // Images
  const mainImage = { src: '/images/Image 3.png', alt: 'Main Photo (Photo 1)' };
  ...
  return (
    <div className="detail-container">
      ...
      <div className="detail-info">
        ...
        <h3 className="detail-price">#5,000,000</h3>
